...
# Move into Waterfall dir
cd "$workdir/Waterfall"
basedir=$(pwd)
# Apply Waterfall
(
    applyPatch ../BungeeCord Waterfall-Proxy HEAD
) || (
    echo "Failed to apply Waterfall Patches"
    enableCommitSigningIfNeeded
    exit 1
) || exit 1
# Move out of Waterfall
basedir="$rootdir"
cd "$basedir"

# Apply patches
applyPatch work/Waterfall/Waterfall-Proxy Waterdrop-Proxy HEAD
